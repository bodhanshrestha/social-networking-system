...
export class AuthService {
  ...
  private issueToken(user: User) {
    const userData = this.authMapper.mapUserToTokenizedUserData(user);
  ...
  public async login(payload: LoginDto): Promise<LoginResponseDto> {
    ...
    const userData = this.authMapper.mapUserToAuthUserDto(user);
    return {
  ...
  public async register(payload: RegisterDto): Promise<RegisterResponseDto> {
    ...
    const userData = this.authMapper.mapUserToAuthUserDto(newUser);
